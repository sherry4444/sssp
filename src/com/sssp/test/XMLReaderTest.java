	...
	public static void main(String args[]) {
		  ...
		  try {
		   ...
		   for (int i = 0; i < childNodes.getLength(); i++) {
		    ...
		    if ("security:http".equals(node1.getNodeName())) {
		     // 如果节点的名称为"Account"，则输出Account元素属性type
		     System.out.println("\r\n找到一篇账号. 所属区域: " + node1.getAttributes().getNamedItem("access").getNodeValue() + ". ");
		     // 获得<Accounts>下的节点
		     ...
		     for (int j = 0; j < nodeDetail.getLength(); j++) {
		      ...
		      if ("security:intercept-url".equals(detail.getNodeName())) // 输出code
